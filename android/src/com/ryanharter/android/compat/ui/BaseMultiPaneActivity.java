...
public abstract class BaseMultiPaneActivity extends BaseActivity {
	...
	/**
	 * Callback that's triggered to find out if a fragment can substitute the given activity
	...
	/**
	 * Called just before a fragment replacement transaction is committed in response to an
	 * intent being fired and substituted for a fragment.
	 */
	...
	/**
	 * A class describing information for a fragment-substitution, used when a fragment can
	 * act in place of an activity.
	 */
